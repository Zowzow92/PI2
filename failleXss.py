...
"""
return all information about an Html form
"""
...
"""
    Given an url, it prints all XSS vulnerable forms founded
"""
def scan_xss(url):
    ...
    print(colored("[WARNING ]","cyan")," Detected ",len(forms)," forms on ",url)
        ...
        with open('xssPayload.txt',encoding="utf-8") as f:
            for script in f:
                ...
                if script in content:
                    print(colored("[CRITICAL]","red"), " Reflected XSS found")
